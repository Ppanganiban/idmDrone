		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getDepXYAccess().getDistanceCSTAssignment_4(), "rule__DepXY__DistanceCSTAssignment_4");
					put(grammarAccess.getDepXYAccess().getTempsCSTAssignment_7(), "rule__DepXY__TempsCSTAssignment_7");
					...
					put(grammarAccess.getDepYZAccess().getDistanceCSTAssignment_4(), "rule__DepYZ__DistanceCSTAssignment_4");
					put(grammarAccess.getDepYZAccess().getTempsCSTAssignment_7(), "rule__DepYZ__TempsCSTAssignment_7");
					...
					put(grammarAccess.getDepXZAccess().getDistanceCSTAssignment_4(), "rule__DepXZ__DistanceCSTAssignment_4");
					put(grammarAccess.getDepXZAccess().getTempsCSTAssignment_7(), "rule__DepXZ__TempsCSTAssignment_7");
					put(grammarAccess.getDepXYZAccess().getNameAssignment_0(), "rule__DepXYZ__NameAssignment_0");
					put(grammarAccess.getDepXYZAccess().getDistanceCSTAssignment_4(), "rule__DepXYZ__DistanceCSTAssignment_4");
					put(grammarAccess.getDepXYZAccess().getTempsCSTAssignment_7(), "rule__DepXYZ__TempsCSTAssignment_7");
