		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getModelAccess().getContextAssignment_6(), "rule__Model__ContextAssignment_6");
					put(grammarAccess.getModelAccess().getAssignementAssignment_7(), "rule__Model__AssignementAssignment_7");
					put(grammarAccess.getModelAccess().getAssignementAssignment_8(), "rule__Model__AssignementAssignment_8");
					put(grammarAccess.getModelAccess().getMainAssignment_11(), "rule__Model__MainAssignment_11");
					...
					put(grammarAccess.getDeclarationAccess().getTypeAssignment_1_0(), "rule__Declaration__TypeAssignment_1_0");
					put(grammarAccess.getDeclarationAccess().getTypePrimitifAssignment_1_1(), "rule__Declaration__TypePrimitifAssignment_1_1");
