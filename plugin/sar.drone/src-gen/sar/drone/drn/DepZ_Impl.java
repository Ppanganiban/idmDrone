 ...
 *   <li>{@link sar.drone.drn.DepZ_Impl#getDistanceVar <em>Distance Var</em>}</li>
 *   <li>{@link sar.drone.drn.DepZ_Impl#getTempsCST <em>Temps CST</em>}</li>
 *   <li>{@link sar.drone.drn.DepZ_Impl#getTempsVAR <em>Temps VAR</em>}</li>
 * </ul>
 *
 ...
 * @generated
 */
public interface DepZ_Impl extends Expression
{
  /**
   ...
   * @see sar.drone.drn.DrnPackage#getDepZ_Impl_DistanceVar()
   * @model
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link sar.drone.drn.DepZ_Impl#getDistanceVar <em>Distance Var</em>}' reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see sar.drone.drn.DrnPackage#getDepZ_Impl_TempsVAR()
   * @model
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link sar.drone.drn.DepZ_Impl#getTempsVAR <em>Temps VAR</em>}' reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
