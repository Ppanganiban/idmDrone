 ...
 * </p>
 * <ul>
 *   <li>{@link sar.drone.drn.With#getName <em>Name</em>}</li>
 *   <li>{@link sar.drone.drn.With#getOption <em>Option</em>}</li>
 * </ul>
 *
 * @see sar.drone.drn.DrnPackage#getWith()
 * @model
 * @generated
 */
public interface With extends EObject
{
   ...
   * @see #setName(String)
   * @see sar.drone.drn.DrnPackage#getWith_Name()
   * @model
   * @generated
   */
  String getName();
  ...
  /**
   * Sets the value of the '{@link sar.drone.drn.With#getName <em>Name</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see sar.drone.drn.DrnPackage#getWith_Option()
