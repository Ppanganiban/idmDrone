...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Dep XImpl</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link sar.drone.drn.impl.DepX_ImplImpl#getName <em>Name</em>}</li>
 *   <li>{@link sar.drone.drn.impl.DepX_ImplImpl#getDistanceCST <em>Distance CST</em>}</li>
 *   <li>{@link sar.drone.drn.impl.DepX_ImplImpl#getDistanceVar <em>Distance Var</em>}</li>
 *   <li>{@link sar.drone.drn.impl.DepX_ImplImpl#getTempsCST <em>Temps CST</em>}</li>
 *   <li>{@link sar.drone.drn.impl.DepX_ImplImpl#getTempsVAR <em>Temps VAR</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DepX_ImplImpl extends ExpressionImpl implements DepX_Impl
{
  /**
  ...
  {
    return DrnPackage.Literals.DEP_XIMPL;
  }
  ...
  public void setName(String newName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, DrnPackage.DEP_XIMPL__NAME, oldName, name));
  }
  ...
  public void setDistanceCST(String newDistanceCST)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, DrnPackage.DEP_XIMPL__DISTANCE_CST, oldDistanceCST, distanceCST));
  }
  ...
  public Parametre getDistanceVar()
  {
    if (distanceVar != null && distanceVar.eIsProxy())
    {
      ...
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, DrnPackage.DEP_XIMPL__DISTANCE_VAR, oldDistanceVar, distanceVar));
      }
    }
    return distanceVar;
  }
  ...
  public void setDistanceVar(Parametre newDistanceVar)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, DrnPackage.DEP_XIMPL__DISTANCE_VAR, oldDistanceVar, distanceVar));
  }
  ...
  public void setTempsCST(String newTempsCST)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, DrnPackage.DEP_XIMPL__TEMPS_CST, oldTempsCST, tempsCST));
  }
  ...
  public Parametre getTempsVAR()
  {
    if (tempsVAR != null && tempsVAR.eIsProxy())
    {
      ...
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, DrnPackage.DEP_XIMPL__TEMPS_VAR, oldTempsVAR, tempsVAR));
      }
    }
    return tempsVAR;
  }
  ...
  public void setTempsVAR(Parametre newTempsVAR)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, DrnPackage.DEP_XIMPL__TEMPS_VAR, oldTempsVAR, tempsVAR));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case DrnPackage.DEP_XIMPL__NAME:
        return getName();
      case DrnPackage.DEP_XIMPL__DISTANCE_CST:
        return getDistanceCST();
      case DrnPackage.DEP_XIMPL__DISTANCE_VAR:
        if (resolve) return getDistanceVar();
        return basicGetDistanceVar();
      case DrnPackage.DEP_XIMPL__TEMPS_CST:
        return getTempsCST();
      case DrnPackage.DEP_XIMPL__TEMPS_VAR:
