 ...
 *   <li>{@link sar.drone.drn.impl.DepY_ImplImpl#getDistanceVar <em>Distance Var</em>}</li>
 ...
 *   <li>{@link sar.drone.drn.impl.DepY_ImplImpl#getTempsVAR <em>Temps VAR</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DepY_ImplImpl extends ExpressionImpl implements DepY_Impl
{
  /**
  ...
  public Parametre getDistanceVar()
  {
    if (distanceVar != null && distanceVar.eIsProxy())
    {
      ...
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, DrnPackage.DEP_YIMPL__DISTANCE_VAR, oldDistanceVar, distanceVar));
      }
    }
    return distanceVar;
  }
  ...
  public void setDistanceVar(Parametre newDistanceVar)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, DrnPackage.DEP_YIMPL__DISTANCE_VAR, oldDistanceVar, distanceVar));
  }
  ...
  public Parametre getTempsVAR()
  {
    if (tempsVAR != null && tempsVAR.eIsProxy())
    {
      ...
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, DrnPackage.DEP_YIMPL__TEMPS_VAR, oldTempsVAR, tempsVAR));
      }
    }
    return tempsVAR;
  }
  ...
  public void setTempsVAR(Parametre newTempsVAR)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, DrnPackage.DEP_YIMPL__TEMPS_VAR, oldTempsVAR, tempsVAR));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case DrnPackage.DEP_YIMPL__NAME:
        return getName();
      case DrnPackage.DEP_YIMPL__DISTANCE_VAR:
      ...
      case DrnPackage.DEP_YIMPL__TEMPS_CST:
        return getTempsCST();
      case DrnPackage.DEP_YIMPL__TEMPS_VAR:
