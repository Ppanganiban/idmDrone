...
public class DrnPackageImpl extends EPackageImpl implements DrnPackage
{
   ...
   * @generated
   */
  private EClass vmaxEClass = null;
   ...
   * @generated
   */
  private EClass hmaxEClass = null;
   ...
   * @generated
   */
  private EClass depXYEClass = null;
   ...
   * @generated
   */
  private EClass depYZEClass = null;
   ...
   * @generated
   */
  private EClass depXZEClass = null;
   ...
   * @generated
   */
  private EClass depXYZEClass = null;
   ...
   * @generated
   */
  public EAttribute getDepXZ_Name()
  {
    return (EAttribute)depXZEClass.getEStructuralFeatures().get(0);
  }
   ...
   * @generated
   */
  public EAttribute getDepXZ_DistanceCST()
  {
    return (EAttribute)depXZEClass.getEStructuralFeatures().get(1);
  }
   ...
   * @generated
   */
  public EAttribute getDepXYZ_IMPL_Name()
  {
    return (EAttribute)depXYZ_IMPLEClass.getEStructuralFeatures().get(0);
  }
   ...
   * @generated
   */
  public EAttribute getDepXYZ_DistanceCST()
  {
    return (EAttribute)depXYZEClass.getEStructuralFeatures().get(0);
  }
  ...
  {
    return (EReference)ledBlinkEClass.getEStructuralFeatures().get(2);
  }
  ...
  public void createPackageContents()
  {
    ...
    vmaxEClass = createEClass(VMAX);

    hmaxEClass = createEClass(HMAX);
  ...
  public void initializePackageContents()
  {
    ...
    vmaxEClass.getESuperTypes().add(this.getLimit());
    hmaxEClass.getESuperTypes().add(this.getLimit());
    ...
    initEAttribute(getLimit_Value(), ecorePackage.getEString(), "value", null, 0, 1, Limit.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(vmaxEClass, Vmax.class, "Vmax", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

    initEClass(hmaxEClass, Hmax.class, "Hmax", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
