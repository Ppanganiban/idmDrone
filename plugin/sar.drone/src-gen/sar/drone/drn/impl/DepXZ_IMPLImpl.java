 ...
 * </p>
 * <ul>
 *   <li>{@link sar.drone.drn.impl.DepXZ_IMPLImpl#getName <em>Name</em>}</li>
 *   <li>{@link sar.drone.drn.impl.DepXZ_IMPLImpl#getTempsCST <em>Temps CST</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DepXZ_IMPLImpl extends MovementImpl implements DepXZ_IMPL
{
  ...
  public void setName(String newName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, DrnPackage.DEP_XZ_IMPL__NAME, oldName, name));
  }
  ...
  public void setTempsCST(int newTempsCST)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, DrnPackage.DEP_XZ_IMPL__TEMPS_CST, oldTempsCST, tempsCST));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case DrnPackage.DEP_XZ_IMPL__NAME:
        return getName();
      case DrnPackage.DEP_XZ_IMPL__TEMPS_CST:
        return getTempsCST();
    }
